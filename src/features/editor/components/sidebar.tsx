    ...
    return (
        <aside className="bg-white flex flex-col w-[100px] h-full border-r overflow-y-auto">
            <ul className="flex flex-col w-full">
                <SidebarItem icon={LayoutTemplate} label="Design" isActive={activeTool === "design"} onClick={()=>onChangeActiveTool("design")}/>
                ...
                <SidebarItem icon={Sparkle} label="AI" isActive={activeTool === "ai"} onClick={()=>onChangeActiveTool("ai")}/>
